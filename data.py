...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="dataset/weather.csv", help="Path to dataset")
    ...
    # set_ranges = {
    #     "train": [0, int(0.6 * n)],
    #     "finetune": [int(0.4 * n), int(0.8 * n)],
    #     "val": [int(0.6 * n), int(0.9 * n)],
    #     "test": [int(0.8 * n), n-1]
    # }
    ...
    set_ranges = {
        "train": [0, int(0.5 * n)],
        "finetune": [int(0.5 * n) - args.seq_len, int(0.8 * n)],
